package collectionTutorial.set;
...
public class TreeSetExample {
	...
	public void treeSetExample(){
		...
		treeSet.add(7);
		treeSet.add(3);
		//treeSet.add(null); //Null values is not allowed. Bcz in TreeSet we will be sorting the values in Natural Sorting Order so it will be comparing the values to sort. At the time Null can't be compared. so It is not allowed.  So, Null-Pointer Exception will be raised
